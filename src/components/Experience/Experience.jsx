const Experience = () => {
  return (
    <div className="mt-20">
      ...
      <div className="divider divider-accent lg:mx-96"></div>
      <div className="card flex flex-col lg:flex-row card-side mx-10 shadow-xl my-10">
        ...
        <div className="card-body flex-1">
          <h2 className="card-title text-3xl text-center mx-auto">PHP and LARAVEL DEVELOPER</h2>
          <div className="flex justify-between">
            <div className="mx-auto">
              <p className="text-2xl font-bold text-[#000] text-center">Internship</p>
              <p className="text-3xl text-center">BackEnd Developer</p>
          ...
          <div className="card-actions justify-end">
            <button className="btn bg-[#4c4c4ce3] hover:bg-[#4C4C4C] text-white mt-5">View Website</button>
          </div>
        </div>
      </div>
        ...
        <div className="p-5 flex-1">
          ...
          <div className="">
            <div>
              ...
              <p className="text-xl text-center ">Brance: Robi Dhanmondi (ROBI & AIRTEL)</p>
